...
class TranTestCase(unittest.TestCase):
    ...
    def test_entry(self):
        ...
        with mock() as m:
            m.post(tran.api_base_url + 'EntryTran.idPass', text="ErrCode=E01|E01&ErrInfo=E01030002|E01040003")
        ...
        with mock() as m:
            m.post(tran.api_base_url + 'EntryTran.idPass', text="AccessID=deadbeefdeadbeefdeadbeefdeadbeef&AccessPass=deadbeefdeadbeefdeadbeefdeadbeef")
    ...
    def test_execute(self):
        ...
        with mock() as m:
            m.post(tran.api_base_url + 'ExecTran.idPass', text="OrderID=1234&Forward=1234567&Method=0&PayTimes=0&Approve=1234567&TranID=1234&TranDate=20161122112233&CheckString=deadbeef")  # CheckString 確認しても良さそう？
    ...
    def test_alter(self):
        ...
        with mock() as m:
            m.post(tran.api_base_url + 'AlterTran.idPass', text='AccessID=1234&AccessPass=1234&Forward=1234&Approve=1234&TranID=1234&TranDate=20160311053322')
    ...
    def test_change(self):
        ...
        with mock() as m:
            m.post(tran.api_base_url + 'ChangeTran.idPass', text='AccessID=1234&AccessPass=1234&Forward=1234&Approve=1234&TranID=1234&TranDate=20160311053322')
