...
class CardTestCase(unittest.TestCase):
    ...
    def test_save(self):
        ...
        with mock() as m:
            m.post(card.API_BASE_URL_PRODUCTION + 'SaveCard.idPass', text="CardSeq=1000&CardNo=1111111111&Forward=1111111")
    ...
    def test_delete(self):
        card = Card()
        with mock() as m:
            m.post(card.API_BASE_URL_PRODUCTION + 'DeleteCard.idPass', text="CardSeq=1000")
    ...
    def test_search(self):
        card = Card()
        with mock() as m:
            m.post(card.API_BASE_URL_PRODUCTION + 'SearchCard.idPass', text="CardSeq=1|2&DefaultFlag=1|0&CardName=poe|foo&CardNo=1234|2345&Expire=1111|1112&HolderName=poe|foo&DeleteFlag=1|0")
    ...
    def test_traded(self):
        card = Card()
        with mock() as m:
            m.post(card.API_BASE_URL_PRODUCTION + 'TradedCard.idPass', text="CardSeq=1&CardNo=1111&Forward=1111")
